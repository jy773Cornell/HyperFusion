...
void configureLockstep(zaber::motion::ascii::Device &device, StageTopology &topology)
{
...
#ifdef HF_HAVE_ZML
bool ZaberStageConfigurator::configure(zaber::motion::ascii::Connection &connection,
                                       ...
                                       StageError &error)
{
    ...
    configureLockstep(device, topology);
