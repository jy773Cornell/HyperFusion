// UR3e live stream tab: scan-route planner (left) + RGB preview (right).
...
QWidget *MainWindow::createUr3eStreamTab()
{
    ...
    auto *routePane =
        ui::createStreamPane(ur3eStreamPage_, QStringLiteral("Scan route"), ur3eScanRoutePlanWidget_);

    QLabel *rgbLabel = nullptr;
    auto *rgbPane = ui::createPreviewPane(ur3eStreamPage_, QStringLiteral("RGB camera"), rgbLabel);
    ur3eRgbPreviewLabel_ = rgbLabel;
    ui::setPreviewDisconnectedText(ur3eRgbPreviewLabel_,
                                     QStringLiteral("RGB preview"),
                                     QStringLiteral("UR3e"));
