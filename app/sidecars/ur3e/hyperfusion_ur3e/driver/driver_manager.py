...
from hyperfusion_ur3e.runtime_paths import (
    driver_stderr_log_path,
...
class Ur3eRosDriverManager:
    ...
    def __init__(
        ...
        *,
        ...
        self._stderr_log_path = driver_stderr_log_path()
    ...
    def write_initial_positions_yaml(joint_deg: List[float]) -> None:
        ...
        pkg_default = PKG_ROOT / "config" / "initial_positions.yaml"
        if out.resolve() != pkg_default.resolve():
            sys.stderr.write(
                f"UR3e driver: install tree not writable — initial_positions -> {out.as_posix()}\n"
            )
    ...
    def start(
        ...
        *,
        ...
        from hyperfusion_ur3e.ros_isolation import bash_domain_exports, ur_driver_ports
    ...
    def _stamper_running() -> bool:
        ...
        return bool(pids_in_current_domain("venv/bin/joint_states_stamper"))
