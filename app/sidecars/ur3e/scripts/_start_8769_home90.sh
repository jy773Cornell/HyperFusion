#!/usr/bin/env bash
# Isolated mock 8769. Home wrist_3 = +90. Mesh bfs_dlp_payload.stl. No 8766. No kill_stale.
set -eo pipefail
...
export HYPERFUSION_UR3E_SERVER_PORT=8769
export HYPERFUSION_UR3E_RUNTIME=/mnt/d/Pototypy/HyperFusion/app/sidecars/ur3e/config/runtime_p8769
export HYPERFUSION_UR_REVERSE_PORT=50201
export HYPERFUSION_UR_SCRIPT_SENDER_PORT=50202
export HYPERFUSION_UR_TRAJECTORY_PORT=50203
export HYPERFUSION_UR_SCRIPT_COMMAND_PORT=50204
