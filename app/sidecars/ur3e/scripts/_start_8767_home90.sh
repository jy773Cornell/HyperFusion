#!/usr/bin/env bash
# Isolated mock 8767 with home wrist_3 = +90. Do not use 8766. No kill_stale.
set -eo pipefail
...
export HYPERFUSION_UR3E_RUNTIME=/mnt/d/Pototypy/HyperFusion/app/sidecars/ur3e/config/runtime_p8767
export HYPERFUSION_UR_REVERSE_PORT=50001
export HYPERFUSION_UR_SCRIPT_SENDER_PORT=50002
export HYPERFUSION_UR_TRAJECTORY_PORT=50003
export HYPERFUSION_UR_SCRIPT_COMMAND_PORT=50004
